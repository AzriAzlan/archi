...
import 'package:ezrestaurantapp/screens/payment_screen.dart';
...
class _CartListState extends State<CartList> {
  ...
  Widget build(BuildContext context) {
    ...
    return checking
        ? Center(
            child: Text(
                "Nothing here for now , add to cart from the home screen!"),
          )
        : Column(
            children: [
              Expanded(
                    ...
                    onPressed: () async {
                      ...
                      showDialog(
                          ...
                          builder: (_) => AssetGiffyDialog(
                                ...
                                title: Text(
                                  'Your total is RM$result',
                                  style: TextStyle(
                                      fontSize: 22.0,
                                      fontWeight: FontWeight.w600),
                                ),
                                description: Text(
                                  'By proceeding , you will be redirected to the FPX gateway to select a payment method of your choice.',
